...
select u.usename as user_name,
 ...
 inner join pg_catalog.pg_user as u on u.usesysid = cl.relowner
...
select at.user_name              as  user_name,
  ...
  join dba.all_tables as at
    on at.schema_name  = kcu.table_schema 
   and at.table_name   = kcu.table_name 
...
select at.user_name               as trigger_user,
  ...
  join dba.all_tables as at
    on at.schema_name = t.event_object_schema
   and at.table_name  = t.event_object_table
  left join (

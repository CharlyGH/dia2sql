...
class EditTable(win.Window):
    def __init__(self, parent, title, schema_name, table_name):
        win.Window.__init__(self, parent, "EditTable", title, self.get_size(800,600,700,80))
        ...
        schema_comment = project.get_schema_info(schema_name, "comment")
        table_comment  = project.get_table_info(schema_name, table_name,"comment")


        lis_len = project.get_column_count(schema_name, table_name)
        ...
        self.columns = project.get_column_list(schema_name, table_name)

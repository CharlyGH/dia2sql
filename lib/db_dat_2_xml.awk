...
/^table#/ {
    ...
    name_attrs = " name='" table "' schema='" schema "' tablespace='" tablespace "'";
    conf_attrs = " auto='" table_auto "' action='create'";
    print "    <table" name_attrs conf_attrs ">";
    print "      <columns>";
    in_column_list  = 1;
    in_trigger_list = 0;
    field_count     = 0;
